...
Q4_Table_New <- Q4_table[-c(1:3), ] #I had to remove the first 3 rows due to the rollmean function not working with NA values. The rows weren't the same and had to be. 
